...
class Blockchain(object):
    ...
    def resolve_conflicts(self):
        ...
        # We're only looking for chains larger than our own
...
# Create the /transactions/new endpoint, which is a POST request, since we'll be adding data
